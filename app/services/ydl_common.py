...
Kept in one place so every service that talks to yt-dlp (audio downloads,
channel listing, caption fetching) uses the same pacing/auth settings and
the same bot-check detection.
"""
